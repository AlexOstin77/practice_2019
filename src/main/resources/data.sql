...
INSERT INTO ORGANIZATION (ID, VERSION, NAME, FULL_NAME, INN, KPP, ADDRESS, PHONE, IS_ACTIVE) VALUES (3, 999, 'КБ ИНТЕГРАЛ', 'ПРОИЗВОДСТВЕННОЕ ОБЪЕДИНЕНИЕ ПОЛЁТ', '5820005566', '582001002', 'ПЕНЗА ПР.СТРОИТЕЛЕЙ Д. 11', '654321', FALSE);

INSERT INTO OFFICE (ID, VERSION, NAME, ADDRESS, PHONE, IS_ACTIVE, ORG_ID) VALUES (0, 999, '', '', '', FALSE, 0);
...
INSERT INTO OFFICE (ID, VERSION, NAME, ADDRESS, PHONE, IS_ACTIVE, ORG_ID) VALUES (4, 999, 'БУХГАЛТЕРИЯ', 'Г.САМАРА УЛ. ОКРУЖНАЯ Д.35', '84699007', FALSE, 2);

INSERT INTO OFFICE (ID, VERSION, NAME, ADDRESS, PHONE, IS_ACTIVE, ORG_ID) VALUES (5, 999, 'ЛАБОРАТОРИЯ', 'Г.МОСКВА УЛ. РЕВОЛЮЦИОННАЯ Д.7', '94512345', TRUE, 3);

INSERT INTO COUNTRY (ID, VERSION, NAME, CODE) VALUES (0, 999, '', '');
...
INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE) VALUES (0, 999, '', '');

INSERT INTO DOC_TYPE(ID, VERSION,  NAME, CODE) VALUES (1, 999, 'Паспорт гражданина РФ', 21);
...
INSERT INTO DOCUMENT (ID, VERSION, NUMBER, DATE, DOC_TYPE_ID) VALUES (12, 999, '522204', '2015-11-07', 22);
...
INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOCUMENT_ID) VALUES (3, 999, 'СЕМЁН', 'СЕМЁНОВИЧ', 'СЕМЁНОВ', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', '94512340', TRUE, 1, 2, 3);
...
INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOCUMENT_ID) VALUES (12, 999, 'АФОНАСИЙ', 'АФОНАСИЕВИЧ', 'АФОНИН', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', '94512341', TRUE, 1, 3, 3);
