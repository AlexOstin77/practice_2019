...
INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (1, 999, 'ИВАН', 'ИВАНОВИЧ', 'ИВАНОВ', 'ГЕНЕРАЛЬНЫЙ ДИРЕКТОР', 94512345, TRUE, 1, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (2, 999, 'ПЁТР', 'ПЁТРОВИЧ', 'ПЕТРОВ', 'ДИРЕКТОР', 94512346, TRUE, 1, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (3, 999, 'СЕМЁН', 'СЕМЁНОВИЧ', 'СЕМЁНОВ', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', 94512340, TRUE, 1, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (4, 999, 'ДМИТРИЙ', 'ФЕДОРОВИЧ', 'ШАЦ', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', 94512340, TRUE, 2, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (5, 999, 'ЕЛИЗАВЕТА', 'АРКАДЬЕВНА', 'ФЕДОРЧУК', 'ГЛАВНЫЙ БУХГАЛТЕР', 9451842, TRUE, 2, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (6, 999, 'ЮСТАС', 'АЛЕКСЕЕВИЧ', 'ИСАЕВ', 'ГЛАВНЫЙ БУХГАЛТЕР', 8421842, TRUE, 3, 2);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (7, 999, 'НИКОЛАЙ', 'ДМИТРИЕВИЧ', 'ХЛЕСТАКОВ', 'БУХГАЛТЕР', 8421841, TRUE, 3, 2);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (8, 999, 'ДУГЛАС', 'КУСТАНАЙВИЧ', 'САБОЙНЕС', 'РУКОВОДИТЕЛЬ ОТДЕЛА', 9451842, TRUE, 4, 2);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (9, 999, 'АЙСЕДОРА', 'АХМАТОВНА', 'ПУШКИНА', 'ГЛАВНЫЙ БУХГАЛТЕР', 8422842, TRUE, 4, 3);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (10, 999, 'ТИМУР', 'БОРИСОВИЧ', 'ЖУК', 'ЗАМЕСТИТЕЛЬ РУКОВОДИТЕЛЯ', 9400842, TRUE, 5, 3);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID) VALUES (11, 999, 'МАРАТ', 'КАЙРАТОВИЧ', 'КАРИМОВ', 'БУХГАЛТЕР', 9451842, TRUE, 5, 3);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (1, 999, '565999', '2002-01-15', 1);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (2, 999, '555999', '2012-10-11', 2);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (3, 999, '555900', '2014-12-31', 3);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (4, 999, '555910', '2015-06-19', 4);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (5, 999, '522900', '2017-11-12', 5);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (6, 999, '522007', '2007-04-19', 6);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (7, 999, '522008', '2017-01-29', 7);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (8, 999, '522901', '2012-03-03', 8);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (9, 999, '522900', '2017-07-23', 9);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (10, 999, '533900', '2015-02-28', 10);

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE, USER_ID) VALUES (11, 999, '522203', '2016-09-27', 11);
