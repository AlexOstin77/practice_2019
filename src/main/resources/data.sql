...
INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (1, 999, '565999', '2002-01-15');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (2, 999, '555999', '2012-10-11');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (3, 999, '555900', '2014-12-31');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (4, 999, '555910', '2015-06-19');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (5, 999, '522900', '2017-11-12');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (6, 999, '522007', '2007-04-19');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (7, 999, '522008', '2017-01-29');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (8, 999, '522901', '2012-03-03');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (9, 999, '522900', '2017-07-23');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (10, 999, '533900', '2015-02-28');

INSERT INTO DOCUMENT (ID, VERSION, DOC_NUMBER, DOC_DATE) VALUES (11, 999, '522203', '2016-09-27');
...
INSERT INTO DOC_TYPE(ID, VERSION,  NAME, CODE, DOCUMENT_ID) VALUES (1, 999, 'Паспорт гражданина Российской Федерации', 21, 1);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (2, 999, 'Военный билет РФ', 7, 1);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (3, 999, 'Временное удостоверение, выданное взамен военного билета РФ', 8, 1);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (4, 999, 'Свидетельство о признании лица беженцем РФ', 11, 2);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (5, 999, 'Вид на жительство в РФ', 12, 2);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (6, 999, 'Удостоверение беженца РФ', 13, 2);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (7, 999, 'Разрешение на временное проживание в РФ', 14, 3);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (8, 999, 'Свидетельство о предоставлении временного убежища РФ', 15, 3);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (9, 999, 'Свидетельство о рождении РФ', 3,3);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (10, 999, 'Паспорт гражданина Республики Беларусь образца 1996 года', 1, 4);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (11, 999, 'Паспорт Республики Беларусь образца 1993 года (Беларусь)', 2, 4);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (12, 999, 'Паспорт СССР образца 1974 года (Беларусь)', 3, 5);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (13, 999, 'Национальный паспорт иностранного гражданина (Беларусь)', 4, 5);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (14, 999, 'Свидетельство о рождении (Беларусь)', 5, 6);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (15, 999, 'Иной документ, удостоверяющий личность (Беларусь)', 6, 7);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (16, 999, 'Справка об освобождении (Беларусь)', 7, 7);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (17, 999, 'Удостоверение беженца (Беларусь)', 8, 8);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (18, 999, 'Вид на жительство в Республике Беларусь', 9, 9);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (19, 999, 'Удостоверение лица без гражданства (Беларусь)', 10, 10);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (20, 999, 'Удостоверение беженца (Беларусь)', 11, 11);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (21, 999, 'Паспорт гражданина Республики Казахстан', 5, 9);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (22, 999, 'Дипломатический паспорт Республики Казахстан', 6, 8);

INSERT INTO DOC_TYPE(ID, VERSION, NAME, CODE, DOCUMENT_ID) VALUES (23, 999, 'Свидетельстов о рождении Республики Казахстан', 7, 10);
