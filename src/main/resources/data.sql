...
INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (1, 999, 'ИВАН', 'ИВАНОВИЧ', 'ИВАНОВ', 'ГЕНЕРАЛЬНЫЙ ДИРЕКТОР', 94512345, TRUE, 1, 1, 1, 1);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (2, 999, 'ПЁТР', 'ПЁТРОВИЧ', 'ПЕТРОВ', 'ДИРЕКТОР', 94512346, TRUE, 1, 1, 2, 2);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (3, 999, 'СЕМЁН', 'СЕМЁНОВИЧ', 'СЕМЁНОВ', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', 94512340, TRUE, 1, 1, 3, 3);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (4, 999, 'ДМИТРИЙ', 'ФЕДОРОВИЧ', 'ШАЦ', 'ЗАМЕСТИТЕЛЬ ДИРЕКТОРА', 94512340, TRUE, 2, 1, 4, 4);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (5, 999, 'ЕЛИЗАВЕТА', 'АРКАДЬЕВНА', 'ФЕДОРЧУК', 'ГЛАВНЫЙ БУХГАЛТЕР', 9451842, TRUE, 2, 1, 5, 5);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (6, 999, 'ЮСТАС', 'АЛЕКСЕЕВИЧ', 'ИСАЕВ', 'ГЛАВНЫЙ БУХГАЛТЕР', 8421842, TRUE, 3, 1, 6, 6);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (7, 999, 'НИКОЛАЙ', 'ДМИТРИЕВИЧ', 'ХЛЕСТАКОВ', 'БУХГАЛТЕР', 8421841, TRUE, 3, 2, 7, 7);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (8, 999, 'ДУГЛАС', 'КУСТАНАЙВИЧ', 'САБОЙНЕС', 'РУКОВОДИТЕЛЬ ОТДЕЛА', 9451842, TRUE, 4, 2, 8, 8);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (9, 999, 'АЙСЕДОРА', 'АХМАТОВНА', 'ПУШКИНА', 'ГЛАВНЫЙ БУХГАЛТЕР', 8422842, TRUE, 4, 2, 9, 9);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (10, 999, 'ТИМУР', 'БОРИСОВИЧ', 'ЖУК', 'ЗАМЕСТИТЕЛЬ РУКОВОДИТЕЛЯ', 9400842, TRUE, 5, 3, 11, 10);

INSERT INTO USER (ID, VERSION, FIRST_NAME, MIDDLE_NAME, SECOND_NAME, POSSITION, PHONE, IS_IDENTIFIED, OFFICE_ID, COUNTRY_ID, DOC_TYPE_ID, DOCUMENT_ID) VALUES (11, 999, 'МАРАТ', 'КАЙРАТОВИЧ', 'КАРИМОВ', 'БУХГАЛТЕР', 9451842, TRUE, 5, 3, 21, 11);
